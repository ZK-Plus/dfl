...
export ADDRESS_5=0x15d34AAf54267DB7D7c367839AAf71A00a2C6A65
...
export PRIVATE_KEY_5=0x47e179ec197488593b187f80a00eb0da91f1b9d0b13f8733639f19c30a34926a
...
echo "Authorized Workers 2 to 5"
...
cast send --rpc-url $rpc_url --private-key $PRIVATE_KEY_1 $DEVICE_REGISTRY_ADDRESS "authorizeAddress(address)" $ADDRESS_5
