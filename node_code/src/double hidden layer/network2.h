...
#define WEIGHTS_AND_BIASES_FILE_PATH R"(./src/double hidden layer/w_and_b.bin)"
...
typedef struct
{
    Eigen::MatrixXd W1, B1, W2, B2, W3, B3; // creates a structure of 6 Eigen matrices
} weights_and_biases;
...
int gradient_descent(weights_and_biases &wab, double learning_rate, int epoch, string train_image_path,
